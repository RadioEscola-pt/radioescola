describe("Check navigation", () => {
    ...
    it("tests category 2 study links", () => {
        ...
        cy.get("#studyLink").click();
        cy.get("#study2Button").click();

        cy.get("#study2Dropdown li a").contains("Bobines").click();
        cy.get("#welcome").should('contain.text', 'O que é uma Bobina?');
        
        cy.get("#study2Dropdown li a").contains("Capacidade de baterias").click();
        cy.get("#welcome").should('contain.text', 'Capacidade de uma bateria');
  
        cy.get("#study2Dropdown li a").contains("Onda estacionária (SWR)").click();
    ...
    it("tests category 3 study links", () => {
        ...
        cy.get("#study3Button").click();
        
        cy.get("#study3Dropdown li a").contains("Alfabeto Fonético").click();
        cy.get("#welcome").should('contain.text', 'Alfabeto Fonético');
        
        cy.get("#study3Dropdown li a").contains("Abreviaturas de Operação").click();
        cy.get("#welcome").should('contain.text', 'Abreviaturas de Operação');
  
        cy.get("#study3Dropdown li a").contains("Definições Genéricas").click();
        cy.get("#welcome").should('contain.text', 'Definições genéricas');
  
        cy.get("#study3Dropdown li a").contains("Entidades e Competências").click();
        cy.get("#welcome").should('contain.text', 'Entidades e suas competências');
  
        cy.get("#study3Dropdown li a").contains("Código Q").click();
        cy.get("#welcome").should('contain.text', 'Código Q');
  
        cy.get("#study3Dropdown li a").contains("Prefixos de indicativos").click();
        cy.get("#welcome").should('contain.text', 'Lista dos prefixos de indicativos de chamada');
  
        cy.get("#study3Dropdown li a").contains("Lei de Ohm").click();
        cy.get("#welcome").should('contain.text', 'Lei de Ohm');
  
        cy.get("#study3Dropdown li a").contains("Corrente Alternada / AC").click();
        cy.get("#welcome").should('contain.text', 'Corrente Alternada / AC');
  
        cy.get("#study3Dropdown li a").contains("Código de cores").click();
        cy.get("#welcome").should('contain.text', 'Código de cores para resistências');
  
        cy.get("#study3Dropdown li a").contains("Mult e SubMult. de Unidades").click();
