  ...
  return (
    <div className="flex items-center justify-between gap-2">
      ...
      <button
        type="button"
        onClick={onReset}
        className={`rounded border border-slate-300 px-3 py-2 text-slate-700 transition hover:bg-slate-100 focus:outline-none focus:ring-2 dark:border-slate-600 dark:text-slate-300 dark:hover:bg-slate-700 ${colorClasses.focus}`}
      >
        {resetLabel ?? t("reset")}
      </button>
    </div>
