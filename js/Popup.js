class Popup {
    ...
    createPopup() {
        ...
        this.overlay.className = "w-full h-full fixed top-0 left-0 z-50 bg-black/80"; 
        this.popup = document.createElement("div");
        this.popup.className = "w-full max-w-4xl h-fit fixed top-1/2 left-1/2 z-50 bg-gray-50 rounded-lg shadow-lg p-8 shadow-lg dark:bg-slate-800 transform -translate-x-1/2 -translate-y-1/2";
